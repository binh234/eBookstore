...
for i in range(18000):
    ...
    if electronic or not traditional:
        ...
        Electronic.objects.create(
            book=book, rent_price=rent_price, rent_duration=rent_duration
        )
...
for storage in storages:
    ...
    for book in book_rand:
        ...
        Import.objects.create(
            book=book,
            storage=storage,
            importTime=faker.date_time_this_century(),
            quantity=q,
...
for storage in storages:
    ...
    for book in book_rand:
        ...
        Export.objects.create(
            book=book,
            storage=storage,
            exportTime=faker.date_time_this_century(),
            quantity=q,
            staff=random.choice(staffs),
        )
...
for storage in storages:
    ...
    for book in book_rand:
        ...
        Import.objects.create(
            book=book,
            storage=storage,
            importTime=faker.date_time_this_month(),
            quantity=q,
            staff=random.choice(staffs),
        )
...
for storage in storages:
    ...
    for book in book_rand:
        ...
        Export.objects.create(
            book=book,
            storage=storage,
            exportTime=faker.date_time_this_month(),
            quantity=q,
            staff=random.choice(staffs),
        )
...
orders = (
    Order.objects.filter(id__gt=115)
